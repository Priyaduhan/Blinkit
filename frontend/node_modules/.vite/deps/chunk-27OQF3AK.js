import {
  require_react_dom
} from "./chunk-3Y55YD2D.js";
import {
  require_jsx_runtime
} from "./chunk-ISAPFGDJ.js";
import {
  __commonJS,
  __toESM,
  require_react
} from "./chunk-P57OYPCV.js";
...
var Portal = React6.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React6.isValidElement(children2) ? getReactElementRef(children2) : null, forwardedRef);
...
var useInsertionEffect2 = React8["useInsertionEffect"] ? React8["useInsertionEffect"] : false;
var useInsertionEffectAlwaysWithSyncFallback = useInsertionEffect2 || syncFallback;
var useInsertionEffectWithLayoutFallback = useInsertionEffect2 || React8.useLayoutEffect;

// node_modules/@emotion/react/dist/emotion-element-489459f2.browser.development.esm.js
var EmotionCacheContext = React9.createContext(
...
var Emotion = withEmotionCache(function(props, cache, ref) {
  ...
  }), React9.createElement(WrappedComponent, newProps));
});
{
...
var jsx = function jsx2(type, props) {
  ...
  return React10.createElement.apply(null, createElementArgArray);
};
(function(_jsx27) {
  var JSX;
  /* @__PURE__ */ (function(_JSX) {
  })(JSX || (JSX = _jsx27.JSX || (_jsx27.JSX = {})));
})(jsx || (jsx = {}));
...
var Global = withEmotionCache(function(props, cache) {
  ...
  var serialized = serializeStyles([styles2], void 0, React10.useContext(ThemeContext));
...
var ClassNames = withEmotionCache(function(props, cache) {
  ...
  hasRendered = true;
  return React10.createElement(React10.Fragment, null, React10.createElement(Insertion3, {
    cache,
    serializedArr
  }), ele);
});
...
function StyledEngineProvider(props) {
  ...
  return cache ? (0, import_jsx_runtime3.jsx)(CacheProvider, {
    value: cache,
    children: children2
  }) : children2;
}
true ? StyledEngineProvider.propTypes = {
   ...
   */
  enableCssLayer: import_prop_types7.default.bool,
  /**
...
function createBox(options = {}) {
  ...
  const Box2 = React16.forwardRef(function Box3(inProps, ref) {
    ...
    return (0, import_jsx_runtime6.jsx)(BoxRoot, {
      as: component,
      ref,
...
var PropsContext = React21.createContext(void 0);
...
function useLayerOrder(theme) {
  ...
  return (0, import_jsx_runtime9.jsx)(GlobalStyles_default, {
    styles: layerOrder
  });
}
  ...
  return (0, import_jsx_runtime10.jsx)(ThemeProvider_default, {
    ...
    children: (0, import_jsx_runtime10.jsx)(ThemeContext.Provider, {
      ...
      children: (0, import_jsx_runtime10.jsx)(RtlProvider_default, {
        value: rtlValue,
        children: (0, import_jsx_runtime10.jsxs)(DefaultPropsProvider_default, {
...
function createContainer(options = {}) {
  ...
  const Container2 = React28.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime13.jsx)(ContainerRoot, {
        as: component,
        ownerState,
...
function isMuiElement(element, muiNames) {
  return React29.isValidElement(element) && muiNames.indexOf(
...
function createGrid(options = {}) {
  ...
  const useUtilityClasses7 = (ownerState, theme) => {
    const {
      container,
      direction,
      spacing: spacing2,
  ...
  const Grid2 = React30.forwardRef(function Grid3(inProps, ref) {
    ...
    const classes = useUtilityClasses7(ownerState, theme);
    return (0, import_jsx_runtime14.jsx)(GridRoot, {
      ref,
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ...other,
      children: React30.Children.map(children2, (child) => {
        if (React30.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
function joinChildren(children2, separator) {
  const childrenArray = React31.Children.toArray(children2).filter(Boolean);
...
function createStack(options = {}) {
  ...
  const Stack2 = React31.forwardRef(function Grid2(inProps, ref) {
    ...
    return (0, import_jsx_runtime15.jsx)(StackRoot, {
      as: component,
      ownerState,
      ref,
      className: clsx_default(classes.root, className),
...
var Fade = React42.forwardRef(function Fade2(props, ref) {
  ...
  return (0, import_jsx_runtime19.jsx)(TransitionComponent, {
    ...
    children: (state, {
      ...
      return React42.cloneElement(children2, {
        style: {
          opacity: 0,
...
var Backdrop = React43.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return (0, import_jsx_runtime20.jsx)(TransitionSlot, {
    in: open,
    timeout: transitionDuration,
    ...other,
    ...transitionProps,
    children: (0, import_jsx_runtime20.jsx)(RootSlot, {
      "aria-hidden": true,
      ...rootProps,
      classes,
      ref,
...
function useEventCallback(fn) {
  const ref = React44.useRef(fn);
  useEnhancedEffect_default(() => {
    ref.current = fn;
  });
  return React44.useRef((...args) => (
...
function useModal(parameters) {
  ...
  const getTransitionProps2 = () => {
    ...
    return {
      onEnter: createChainedFunction(handleEnter, children2?.props.onEnter ?? noop2),
      onExited: createChainedFunction(handleExited, children2?.props.onExited ?? noop2)
    };
  };
  return {
    getRootProps,
...
var Modal = React46.forwardRef(function Modal2(inProps, ref) {
  const props = useDefaultProps2({
    name: "MuiModal",
    props: inProps
  });
  ...
  return (0, import_jsx_runtime21.jsx)(Portal_default, {
    ...
    container,
    disablePortal,
    children: (0, import_jsx_runtime21.jsxs)(RootSlot, {
      ...rootProps,
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime21.jsx)(BackdropSlot, {
        ...backdropProps
      }) : null, (0, import_jsx_runtime21.jsx)(FocusTrap_default, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
        isEnabled: isTopModal,
        open,
        children: React46.cloneElement(children2, childProps)
      })]
    })
  });
});
true ? Modal.propTypes = {
   ...
   * @default false
   */
  closeAfterTransition: import_prop_types31.default.bool,
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   */
  onTransitionEnter: import_prop_types31.default.func,
  /**
   * A function called when a transition has exited.
   */
  onTransitionExited: import_prop_types31.default.func,
  /**
   * If `true`, the component is shown.
   */
...
var SvgIcon = React47.forwardRef(function SvgIcon2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiSvgIcon"
  });
  ...
  const hasSvgAsChild = React47.isValidElement(children2) && children2.type === "svg";
  const ownerState = {
    ...props,
    color: color2,
    component,
  ...
  return (0, import_jsx_runtime22.jsxs)(SvgIconRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    focusable: "false",
    color: htmlColor,
...
var Slide = React50.forwardRef(function Slide2(props, ref) {
  ...
  return (0, import_jsx_runtime24.jsx)(TransitionComponent, {
    ...
    children: (state, {
      ...
      return React50.cloneElement(children2, {
        ref: handleRef,
        style: {
          visibility: state === "exited" && !inProp ? "hidden" : void 0,
          ...style4,
...
var Drawer = React52.forwardRef(function Drawer2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiDrawer"
  });
  ...
  const mounted = React52.useRef(false);
  React52.useEffect(() => {
  ...
  const externalForwardedProps = {
    ...
    slotProps: {
      ...
      ...slotProps,
      backdrop: mergeSlotProps2(slotProps.backdrop || {
        ...BackdropProps,
        ...BackdropPropsProp
      }, {
        transitionDuration
  ...
  const drawer = (0, import_jsx_runtime26.jsx)(PaperSlot, {
    ...paperSlotProps,
    children: children2
  });
  if (variant === "permanent") {
    return (0, import_jsx_runtime26.jsx)(DockedSlot, {
      ...dockedSlotProps,
      children: drawer
    });
  }
  const slidingDrawer = (0, import_jsx_runtime26.jsx)(TransitionSlot, {
    ...transitionSlotProps,
    children: drawer
  });
  ...
  return (0, import_jsx_runtime26.jsx)(RootSlot, {
    ...rootSlotProps,
    children: slidingDrawer
  });
});
true ? Drawer.propTypes = {
  ...
  slotProps: import_prop_types35.default.shape({
    ...
    docked: import_prop_types35.default.oneOfType([import_prop_types35.default.func, import_prop_types35.default.object]),
  ...
  slots: import_prop_types35.default.shape({
    ...
    docked: import_prop_types35.default.elementType,
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-27OQF3AK.js.map
