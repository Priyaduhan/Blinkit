  ...
  return (
    <div>
      <div className="inset-0 fixed bg-gray-800/50 backdrop-blur-[1px] z-[100] flex justify-center ">
        <div className="h-[100vh] w-[90vw] md:w-[34rem] md:h-[36rem] flex md:mt-10 flex-col items-center p-4  gap-2  bg-white rounded-lg sm:relative overflow-y-auto">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="flex gap-6 flex-col mt-0 md:mt-2 md:w-[32rem]">
              ...
              <div className="flex justify-center  gap-2 relative">
                <input
                  ...
                  className="border-gray-600 border-2 rounded-md p-1 w-[80vw] placeholder-gray-400 md:w-[26.5rem]"
                  {...register("pinCode", {
                    required: true,
                  })}
                />
              ...
              <div className="flex justify-center">
                <button className="bg-green-700 text-white font-bold p-2 px-4 rounded-sm cursor-pointer hover:bg-green-600">
                  Sign Up
                </button>
              </div>
              <div className="flex justify-center">
